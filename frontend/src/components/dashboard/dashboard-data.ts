...
export const dashboardPages = {
  admin: {
    ...
    menu: [
      ...
      { key: "homeSlider", label: "اسلاید صفحه اصلی", href: "/dashboard/admin/home-slider", icon: "image", description: "مدیریت اسلایدهای صفحه اصلی", emptyText: emptyDetail, roles: ["general_manager"] },
      { key: "pages", label: "صفحه درباره ما", href: "/dashboard/admin/pages", icon: "file", description: "ویرایش صفحه از پیش تعریف‌شده درباره ما", emptyText: emptyDetail, roles: ["general_manager"] },
      { key: "reports", label: "گزارش‌ها", href: "/dashboard/admin/reports", icon: "chart", description: "گزارش عملکرد واحدها و دریافت خروجی CSV", emptyText: emptyDetail, roles: ["general_manager"] },
      { key: "staff", label: "کادر مدرسه", href: "/dashboard/admin/staff", icon: "staff", description: "مدیریت اعضای کادر", emptyText: emptyDetail, roles: ["general_manager"] },
      { key: "students", label: "دانش‌آموزان", href: "/dashboard/admin/students", icon: "students", description: "مدیریت پرونده دانش‌آموزان", emptyText: emptyDetail, roles: ["general_manager"] },
  ...
  contentManager: {
    ...
    menu: [
      ...
      { key: "virtualTour", label: "تور مجازی", href: "/dashboard/content-manager/virtual-tour", icon: "virtualTour", description: "مدیریت صحنه‌های تور مجازی واحد", emptyText: emptyDetail, roles: ["general_manager", "unit_manager", "unit_media"] },
