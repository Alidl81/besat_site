...
export const dashboardPages = {
  admin: {
    ...
    menu: [
      ...
      { key: "pages", label: "صفحات ایستا", href: "/dashboard/admin/pages", icon: "file", description: "مدیریت صفحات معرفی مجموعه", emptyText: emptyDetail, roles: ["general_manager"] },
      { key: "reports", label: "گزارش‌ها", href: "/dashboard/admin/reports", icon: "chart", description: "گزارش عملکرد واحدها", emptyText: emptyDetail, roles: ["general_manager"] },
