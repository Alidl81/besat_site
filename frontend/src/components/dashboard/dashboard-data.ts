...
export const dashboardPages = {
  admin: {
    ...
    menu: [
      ...
      { key: "reports", label: "گزارش‌های مدیریتی", href: "/dashboard/admin/reports", icon: "chart", description: "گزارش‌های کلان مدیریتی", emptyText: emptyDetail },
      { key: "settings", label: "تنظیمات مجموعه", href: "/dashboard/admin/settings", icon: "settings", description: "تنظیمات عمومی مجموعه", emptyText: emptyDetail },
      ...
      { key: "services", label: "خدمات پرورشی", href: "/dashboard/admin/services", icon: "heart", description: "مدیریت خدمات پرورشی مجموعه", emptyText: emptyDetail },
  ...
  media: {
    ...
    menu: [
      ...
      { key: "services", label: "سرویس‌های درس‌افزار", href: "/dashboard/media/services", icon: "services", description: "سرویس‌های متصل مدرسه", emptyText: emptyDetail },
  ...
  parents: {
    ...
    menu: [
      ...
      { key: "children", label: "فرزندان من", href: "/dashboard/parents/children", icon: "children", description: "اطلاعات تحصیلی فرزندان", emptyText: emptyDetail },
      { key: "programs", label: "برنامه‌ها", href: "/dashboard/parents/programs", icon: "programs", description: "برنامه‌های فرزند", emptyText: emptyDetail },
      ...
      { key: "registration", label: "ثبت‌نام", href: "/dashboard/parents/registration", icon: "registration", description: "ثبت‌نام سال تحصیلی", emptyText: emptyDetail },
      { key: "services", label: "سرویس‌های درس‌افزار", href: "/dashboard/parents/services", icon: "services", description: "سرویس‌های آموزشی متصل", emptyText: emptyDetail },
