...
export const panelData = {
  admin: {
    ...
    menu: [
      ...
      { key: "settings", label: "تنظیمات", href: "/admin/settings", icon: "⚙", emptyText },
    ],
    cards: [
  ...
  unitManager: {
    ...
    menu: [
      ...
      { key: "settings", label: "تنظیمات واحد", href: "/unit-manager/settings", icon: "⚙", emptyText },
    ],
    cards: [
  ...
  media: {
    ...
    menu: [
      ...
      { key: "settings", label: "تنظیمات", href: "/media/settings", icon: "⚙", emptyText },
    ],
    cards: [
      { title: "پیام‌ها", value: null, note: emptyText, icon: "✉" },
